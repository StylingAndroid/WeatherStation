node {
  ...
  stage('Report') {
        ...
        jacoco exclusionPattern: '**/R.class, **/R$*.class, **/*$ViewInjector*.*, **/BuildConfig.*, **/Manifest*.*, **/*Test*.*, android/**/*.*, androidx/**/*.*'**/*ViewModel_Factory.*, **/*_MembersInjector.class, **/Dagger*Component.class, **/Dagger*Component$**, **/Dagger*Component$Builder.class, **/*Module_*Factory.class'gr, classPattern: '**/classes, **/tmp/kotlin-classes/debug'
  }
}
